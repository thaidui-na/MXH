...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Chỉnh sửa nhóm</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('groups.update', $group->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if($group->cover_image)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($group->cover_image) }}" alt="Current Cover" class="img-fluid" style="max-height: 200px;">
                                </div>
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            @if($group->avatar)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($group->avatar) }}" alt="Current Avatar" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                </div>
                            @endif
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_private" name="is_private" value="1" {{ old('is_private', $group->is_private) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('groups.show', $group) }}" class="btn btn-secondary">Hủy</a>
